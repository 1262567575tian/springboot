    ...
    <div class="r-filter">
      <div class="f-sort">
        <div class="pagin">
          ...
          <a href="javascript:;" class="prev" <c:if test="${page > 1 }"> onclick="page1('${page - 1}')"</c:if> >上页</a>
         <!--  <a class="prev">上一页</a> -->
          <c:if test="${page >= totalPages }"></c:if>
          <a href="javascript:;" class="next" <c:if test="${page < totalPages }"> onclick="page1('${page + 1}')"</c:if> >下页</a>
          <!-- <a class="next">下一页</a>     -->   	
          </div>
    ...
    <div class="p-list">
      <ul class="list-all">
         ...
         <li>
            <div class="l-wrap">
				<div class="pic">
					<a class="trackref" href="http://localhost:8029/item/${item.id}" title="" target="_blank">
	        	...
	        	<div class="title-b" style=""><a class="trackref" href="http://localhost:8086/item/${item.id}.html" target="_blank">${sellPoint }</a></div>
	            <div class="comment">
